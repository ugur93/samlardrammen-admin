        ...
        <Container sx={{ mt: 4 }}>
                    ...
                    <TableBody>
                        {data?.map((organization) => (
                            <TableRow key={organization.organization.id}>
                                <TableCell>
                                    <Link href={'/organization/' + organization.organization.id}>
                                ...
                                <TableCell>
                                    <IconButton onClick={() => setCreateOrEdit(organization)}>
                                        <EditIcon />
                                    </IconButton>
                                </TableCell>
                                <TableCell>
            ...
            {createOrEdit != false && (
                <CreateOrganizationDialog
                    open
                    organization={typeof createOrEdit == 'object' ? createOrEdit : undefined}
