...
import type { PaymentDetailDatabase } from '../types/personTypes';

type OrganizationDetailsPageProps = {
    organizationId: string;
};
export const OrganizationDetailsPage: React.FC<OrganizationDetailsPageProps> = ({ organizationId }) => {
    return (
...
const OrganizationDetailsView: React.FC<OrganizationDetailsPageProps> = ({ organizationId }) => {
